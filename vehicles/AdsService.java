...
import vehicles.vehicleTypes.vehicleTypeByBodyTypes.VehicleTypeByBodyTypes;
import vehicles.vehicleTypes.vehicleTypeByFuelTypes.VehicleTypeByFuelTypes;
import vehicles.vehicleTypes.vehicleTypeByPurpose.VehicleTypeByPurpose;
        ...
        for (VehicleAd ad: adList) {
            if (ad.getVehicleTypeByPurpose().equals(vehicleType)) {
                ...
                System.out.println("Объявление № " + ad.getId() + " не прошло фильтр: тип авто - "
                        + vehicleType.getTypeName() + ", критерий " + vehicleType.getAttributeOfType() + ", так как имеет тип авто " +
